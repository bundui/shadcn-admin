    ...
    <>
      <Card>
        <CardHeader>
          ...
          <CardDescription>Members Information</CardDescription>
        </CardHeader>
        <CardContent className="space-y-3">
          <div>
            <span className="font-medium">Phone:</span>
            <span className="text-muted-foreground ml-2">+16478987143</span>
          </div>
          <div>
            <span className="font-medium">Email:</span>
            <span className="text-muted-foreground ml-2">hassan@gmail.com</span>
          </div>
          <div>
              ...
              <tbody>
                {bookings.map((booking, index) => (
                  <tr key={index} className="border-b hover:bg-gray-50">
                    ...
                    <td className="text-muted-foreground px-4 py-4">{booking.clients}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <div className="text-muted-foreground">He hasn&#39;t done anything yet.</div>
        </CardContent>
      </Card>
    </>
  );
