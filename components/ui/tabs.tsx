...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div className="relative" ref={tabsListRef}>
      ...
      />
      <div
        className="bg-background dark:border-input dark:bg-input/30 absolute rounded-md border border-transparent shadow-sm transition-all duration-300 ease-in-out"
